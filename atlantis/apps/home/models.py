...
class ViewSumStop(models.Model):
...
class ViewTBusStop(models.Model):
    transportation_bus_id = models.IntegerField()
    day_of_week = models.CharField(max_length=10, db_collation='utf8_general_ci', blank=True, null=True)
    depart_bus_stop_id = models.IntegerField(blank=True, null=True)
    depart_bus_stop_name = models.CharField(max_length=200, db_collation='utf8mb4_general_ci', blank=True, null=True)
    depart_bus_stop_lat = models.DecimalField(max_digits=10, decimal_places=4, blank=True, null=True)
    depart_bus_stop_lot = models.DecimalField(max_digits=10, decimal_places=4, blank=True, null=True)
    arrival_bus_stop_id = models.IntegerField(blank=True, null=True)
    arrival_bus_stop_name = models.CharField(max_length=200, db_collation='utf8mb4_general_ci', blank=True, null=True)
    arrival_bus_stop_lat = models.DecimalField(max_digits=10, decimal_places=4, blank=True, null=True)
    arrival_bus_stop_lot = models.DecimalField(max_digits=10, decimal_places=4, blank=True, null=True)
...
class ViewTMetroStation(models.Model):
    transportation_metro_id = models.IntegerField()
    day_of_week = models.CharField(max_length=10, db_collation='utf8_general_ci', blank=True, null=True)
    depart_metro_station_id = models.IntegerField(blank=True, null=True)
    depart_metro_station_name = models.CharField(max_length=200, db_collation='utf8mb4_general_ci', blank=True, null=True)
    depart_metro_station_lat = models.DecimalField(max_digits=10, decimal_places=7, blank=True, null=True)
    depart_metro_station_lot = models.DecimalField(max_digits=10, decimal_places=7, blank=True, null=True)
    arrival_metro_station_id = models.IntegerField(blank=True, null=True)
    arrival_metro_station_name = models.CharField(max_length=200, db_collation='utf8mb4_general_ci', blank=True, null=True)
    arrival_metro_station_lat = models.DecimalField(max_digits=10, decimal_places=7, blank=True, null=True)
    arrival_metro_station_lot = models.DecimalField(max_digits=10, decimal_places=7, blank=True, null=True)
